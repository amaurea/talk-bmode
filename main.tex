...
%
%%Don't want to get too specific about foregrounds before starting BICEP
%%section. Need a natural way to go from the short foreground summary
%%to CMB spectra.
%%
...
\begin{frame}{Planck to the rescue (or not)}
	\begin{center}
		\begin{tikzpicture}
