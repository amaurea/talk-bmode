...
\begin{frame}{How the telescope actually observes}
	...
	\end{tikzpicture}
	\begin{center}
		\uncover<10->{\large Time-ordered data (TOD)}
	\end{center}
\end{frame}
...
\begin{frame}{Handling sky systematics}
	...
	\end{itemize}
	\[
		\underbrace{\mimg{out_dirty/null2_0.png}{2.0cm}}_{\textrm{148 GHz}} +
		\underbrace{\mimg{out_dirty/null2_1.png}{2.0cm}}_{\textrm{353 GHz}} =
		\underbrace{\mimg{out_dirty/null2_2.png}{2.0cm}}_{\textrm{CMB}} +
		\underbrace{\mimg{out_dirty/null2_3.png}{2.0cm}}_{\textrm{Dust}}
	\]
\end{frame}
